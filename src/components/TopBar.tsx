          ...
          <div className="flex items-center gap-2.5">
            ...
            {state.user.isAuthenticated ? (
              ...
              <motion.button
                ...
                className="px-4 py-1.5 rounded-full bg-slate-900 dark:bg-white text-white dark:text-black font-black text-xs hover:bg-slate-800 dark:hover:bg-zinc-200 transition-all shadow-md cursor-pointer"
              >
                Sign In
              </motion.button>
            )}
